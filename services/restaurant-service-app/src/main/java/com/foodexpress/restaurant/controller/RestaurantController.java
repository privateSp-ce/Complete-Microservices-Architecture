...
public class RestaurantController {
    ...
    public ResponseEntity<ApiResponse<RestaurantResponse>> verifyRestaurant(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<RestaurantResponse>> toggleAcceptingOrders(@PathVariable String id) {
